...
public class Ex04Coda { //FIFO (First In, First Out)
    ...
    public void printArray(int size)
    {
        ...
        else
        {
            ...
            while (i < size)
            {
                System.out.println(" " + (i + 1) + "° element: " + this.array[i]);
                i++;
            }
            System.out.println("- - - - - - - - - - ");
        }
    ...
    public static void initArray(Ex04Coda obj)
    {
