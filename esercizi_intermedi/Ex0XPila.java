...
public class Ex0XPila {
    ...
    public static void initArray(Ex0XPila obj)
    {
            ...
            try {
                ...
                switch (input) {
                    ...
                    case (3):
                        ...
                        obj.printArray(obj.array.length);
                        System.out.print("Digit the element's position you want tot remove: ");
                        int elementToRemove = obj.scanner.nextInt();
                        if (elementToRemove > 0 && elementToRemove <= obj.array.length)
                        {
                            obj.array = obj.removeElement(obj.array, elementToRemove - 1);
                            System.out.print("The array is now: ");
                            obj.printArray(obj.array.length);
                        }
                        else
                            System.out.println(RED + "ERROR: position not valid" + RESET);
                        break ;
                    case (4):
                        obj.scanner.close();
                        System.exit(0);
